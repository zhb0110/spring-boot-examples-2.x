...
public class ShiroConfig {
    ...
    // TODO:上面指定的securityManager，根据参数名称
    @Bean
    public SecurityManager securityManager() {

        System.out.println("看上面shiroFilterFactoryBean是怎么自动找到这里的：securityManager--实践证明，根据参数名称");
...
//        System.out.println("看上面shiroFilterFactoryBean是怎么自动找到这里的：securityManager1--实践证明，根据参数名称");
//
//        // 配置SecurityManager，并注入shiroRealm
//        DefaultWebSecurityManager securityManager = new DefaultWebSecurityManager();
//        securityManager.setRealm(shiroRealm());
